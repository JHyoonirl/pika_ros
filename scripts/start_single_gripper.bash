...
source /root/pika_ros/install/setup.bash && ros2 launch sensor_tools open_single_gripper.launch.py serial_port:=/dev/ttyUSB60 fisheye_port:=60 camera_fps:=$camera_fps camera_width:=$camera_width camera_height:=$camera_height camera_profile:=$camera_width,$camera_height,$camera_fps joint_name:=center_joint
