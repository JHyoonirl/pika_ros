...
echo -e "${GREEN}=== Pika Device Linker (Docker Mode) ===${NC}"
...
# Left Sensor
make_link "$L_SENSOR_SERIAL_ADDR" "tty"   "pika_sensor_left_serial"
make_link "$L_SENSOR_VIDEO_ADDR"  "video" "pika_sensor_left_video"
